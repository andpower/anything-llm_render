...
async function handleChatRequest(request, response, thread = null) {
  try {
    ...
    await streamChatWithWorkspace(response, workspace, message, mode, user, thread);
...
app.post(
  ...
  (request, response) => handleChatRequest(request, response, response.locals.thread)
);
