...
export default function ChatHistory({ history = [], workspace, sendCommand }) {
  ...
  return (
    <div
      className="markdown text-white font-medium text-sm h-full md:h-[83%] pb-[100px] pt-6 md:pt-0 md:pb-20 md:mx-0 overflow-y-scroll flex flex-col justify-start no-scroll"
      id="chat-history"
      ref={chatHistoryRef}
    >
